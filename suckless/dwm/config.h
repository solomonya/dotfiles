...
static const char *listwindowscmd[] = { "rofi", "-show", "window", NULL };
static const char *updatelngblock[] = { "pkill", "-RTMIN+1", "dwmblocks", NULL };
...
static const Key keys[] = {
  ...
  { MODKEY,                       XK_9,                       spawn,          {.v = blurlockcmd } },
	{ MODKEY,                       XK_p,                       spawn,          {.v = listwindowscmd } },
  ...
  { 0,                            XF86XK_MonBrightnessDown,   spawn,          SHCMD("brightnessctl g 5%-") },
	{ 0,                            XK_ISO_Next_Group,          spawn,          {.v = updatelngblock } },
